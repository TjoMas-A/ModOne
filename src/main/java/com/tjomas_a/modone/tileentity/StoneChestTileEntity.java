...
import com.tjomas_a.modone.reference.Sounds;
...
public class StoneChestTileEntity extends MOTileEntity implements IInventory
{
    ...
    /**
     * The number of players currently using the chest
     */
    ...
    public StoneChestTileEntity(int metaData) {
        super();
    ...
    {
        return this.hasCustomName() ? this.getCustomName() : Names.Containers.STONE_CHEST;
    }
    ...
    {
        ++numUsingPlayers;
        worldObj.addBlockEvent(xCoord, yCoord, zCoord, ModBlocks.stoneChest, 1, numUsingPlayers);
    }
